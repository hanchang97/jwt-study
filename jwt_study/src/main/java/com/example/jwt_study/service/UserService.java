...
public class UserService {
    ...
    public Optional<User> getMyUserWithAuthorities() {
     ...
     @Transactional
    public User updateInfo(User user, String username, String password, String nickname){
        //업데이트 하려는 유저 가져오기
